...
public class JavaFXDynTable extends Application {
    ...
    static final String Day[] = {"Monday", "Tuesday", "Wednesday", "Thursday",
            "Friday"};
    ...
    public static class Record {
        ...
        Record(int i, int v0, int v1, int v2, int v3, int v4) {
    ...
    public void start(Stage primaryStage) {
        ...
        TableColumn<Record, String> col_id = new TableColumn<>("ID");
        ...
        for (int i = 0; i < Day.length; i++) {
            ...
            col.setCellValueFactory(new PropertyValueFactory<Record, String>(
    ...
    EventHandler<ActionEvent> btnNewHandler = new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent t) {
            ...
            int newId = data.size();
            Record newRec = new Record(newId, random.nextInt(100),
